...
Install additional libraries from Bioconductor:
+ topGO,
+ clusterProfiler,
+ org.Hs.eg.db,
+ enrichplot
...
BiocManager::install(c("topGO", "clusterProfiler","org.Hs.eg.db","enrichplot"))
```


```{r eval=FALSE, include=FALSE}
install.packages(c("VennDiagram", "data.table", "KernSmooth"))
```
