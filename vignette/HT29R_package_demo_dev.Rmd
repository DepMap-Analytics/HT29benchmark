...
Install additional libraries from Bioconductor and CRAN, if they are found not 
alredy installed:
...
The system will create a directory (i.e., the 'HT29R_resFolder') in the local folder, in which the reference dataset (sgRNA depletion fold changes or sgRNA counts) will be downloaded. A subdirectory will be used for the plots (which are reproduced if the 'saveToFig' parameter of the HT29benchmark functions is set to 'TRUE').
...
#userData must contain the data not the path
